  ...
  return (
    <div className="page-enter min-h-screen px-8 py-32">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl mb-12 text-white/80 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Featured work and research</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              From Games to Governance: How Identity Cues Reshape Strategy in Multi-Agent LLMs
            </h2>
            
            <p className="mb-6 text-white/90 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            ...
            <div className="flex gap-4">
              <a
                ...
                download
                className="flex items-center gap-2 px-6 py-3 bg-[#00FF94] text-black font-semibold hover:bg-white transition-colors shadow-lg"
              >
                <Download size={20} />
                Download PDF
              </a>
          ...
          {[
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-3 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{project.title}</h3>
              <p className="text-white/70 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{project.desc}</p>
            </div>
          ))}
        </div>
      </div>
