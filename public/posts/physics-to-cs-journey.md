...
Simply put, there are more jobs in computer science that can use the mathematical and computational background that physics students learn than there are physics research jobs, and this is the most common reason people jump ship. But when I think about it, my reasons were more nuanced than that.

## Before the Switch
I liked physics because it offered a way to take something complicated, strip it down to a few assumptions, and build a model that could explain what happened next. I also grew up next to the observatory, so the stars (and the laws that governed them) enchanted me.

I had also done a week of research in materials science through a program that selected 30 high school students nationally. I liked it overall, but I did feel the grandeur of physics appeal to me more.
...
I still attribute that rank to a great deal of luck, as well as exam-taking skill, but it did show me that I was good at this computer science thing. For a long time, I had also considered switching to mathematics, another subject I spent way too much free time on, and weighed the pros of staying in physics, but this exam result finally convinced me to take the leap and switch to CS.

## The Useful Baggage
Officially moving into CS did not feel like starting over. A surprising amount of knowledge came with me.

Physics had trained me to ask what could be ignored. Most real systems are impossibly complicated if you try to represent every detail. You need to decide which variables matter, which interactions dominate, and what approximation is good enough for the question you are asking. Physics itself also has a lot of programming and ML, as computation is needed in most STEM fields that rely heavily on mathematics.

The mathematical background helped too, particularly linear algebra, probability, and the habit of checking whether an answer is even plausible before trusting it. Perhaps a bit too much, as I found myself enjoying the theoretical courses the most, but that did help me get through EPFL's infamous first-year "filter."

## What Did Not Transfer Cleanly

The cultures are different. Language works differently in both fields.

In physics, the main language is mathematics. I was used to ideas remaining useful for a long time. A derivation does not stop working because a new framework was released on Tuesday. In software, the surrounding machinery changes constantly. Libraries disappear, conventions flip, and yesterday's sensible architectural choice becomes today's migration project.

At first I mistook knowing tools for knowing CS. There is always another language, framework, database, or deployment system that everyone else appears to understand already. Trying to catch up with all of it is a very efficient way to feel permanently behind. CS's true language is also mathematics, but it's typically not the one you use to describe your high-level systems.

It took me a while to separate the two, but I then ended up merging them again as I shifted more into the world of machine learning and artificial intelligence.
